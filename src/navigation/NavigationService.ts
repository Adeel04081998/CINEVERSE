...
export const _NavgationRef = React.createRef<NavigationContainerRef<any>>();
export const NavigationActions = {
    common_actions: {
        navigate: (name = "", params = {}, navigation:any = _NavgationRef.current) => {
        ...
        navigateStack: (name = "", params = {}, navigation:any = _NavgationRef.current, navigatorName = "AppStack",) => {
            navigation = _NavgationRef.current
            navigation.navigate(navigatorName, { screen: name, params });

        },
        goBack: (route = null, navigation:any = _NavgationRef.current) => {
            if (route) {
